...
RUN git clone --depth=1 --branch v0.22.0 https://github.com/badaix/snapcast.git && cd snapcast && git submodule update --init --recursive
...
RUN dpkg -i /snapserver_0.22.0-1_arm64.deb
